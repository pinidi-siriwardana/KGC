            ...
            <header className="relative z-10 flex items-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-emerald-600 text-[10px] font-black uppercase tracking-[0.3em] mt-2">
                        {loading ? 'Loading...' : (member?.full_name || 'Member')}
                    </p>
                </div>
            </header>
                    ...
                    <form onSubmit={handleProfileSubmit} className="space-y-5">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-emerald-600/10 disabled:opacity-50"
                ...
                <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-8">
                    ...
                    <form onSubmit={handlePasswordSubmit} className="space-y-5">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-slate-900 px-6 py-3 rounded-xl text-white font-black uppercase tracking-widest text-[10px] hover:bg-emerald-600 transition-all shadow-lg disabled:opacity-50"
                        >
