...
const AdminProfile = () => {
    ...
    return (
        <div className="relative space-y-10 animate-in fade-in duration-700">
            <div className="absolute -top-20 -right-20 w-80 h-80 bg-purple-500/10 blur-[100px] rounded-full pointer-events-none opacity-60" />

            <header className="relative z-10 flex items-center gap-5">
                <div className="w-20 h-20 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center shrink-0">
                    <CircleUserRound size={44} strokeWidth={1.5} />
                </div>
                <div>
                    <h1 className="text-slate-900 text-4xl font-serif italic">Profile Settings</h1>
                    <p className="text-purple-600 text-[10px] font-black uppercase tracking-[0.3em] mt-2">
                        {loading ? 'Loading...' : (admin?.username || 'Administrator')}
                    </p>
                </div>
            </header>
                ...
                <div className="bg-white border border-slate-100 shadow-sm rounded-3xl p-8">
                    ...
                    <form onSubmit={handleProfileSubmit} className="space-y-5">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-purple-600 px-6 py-3 rounded-xl text-white font-black uppercase tracking-widest text-[10px] hover:bg-slate-900 transition-all shadow-lg shadow-purple-600/20 disabled:opacity-50"
                        >
                    ...
                    <form onSubmit={handlePasswordSubmit} className="space-y-5">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm outline-none focus:ring-4 focus:ring-purple-500/10"
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-slate-900 px-6 py-3 rounded-xl text-white font-black uppercase tracking-widest text-[10px] hover:bg-purple-600 transition-all shadow-lg disabled:opacity-50"
                        >
