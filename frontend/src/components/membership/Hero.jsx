...
const MembershipHero = () => {
  return (
    ...
    <section className="relative min-h-screen bg-obsidian overflow-hidden flex flex-col pt-20">
      ...
      {/* High-Contrast Brand Glows */}
      <div className="absolute top-[-10%] right-[-5%] w-[700px] h-[700px] bg-emerald/10 blur-[180px] rounded-full z-0" />
      <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-amber/5 blur-[150px] rounded-full z-0" />
          ...
          <div className="lg:col-span-6 relative z-20 space-y-12">
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <p className="text-white/40 max-w-md font-sans font-light leading-relaxed text-lg italic">
              ...
              <div className="flex flex-col sm:flex-row gap-8 pt-6">
                 <div className="flex items-center gap-4 group cursor-help">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/50 group-hover:text-white transition-colors">Priority Access</span>
                 </div>
                 ...
                 <div className="flex items-center gap-4 group cursor-help">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest text-white/50 group-hover:text-white transition-colors">Elite Events</span>
                 </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative aspect-[4/5] lg:aspect-square w-full max-w-xl ml-auto">
              ...
              <div className="relative h-full w-full rounded-club overflow-hidden shadow-[0_80px_100px_-30px_rgba(0,0,0,0.8)] border border-white/10 group bg-obsidian">
                <img 
                  src={memberHeroImg} 
                  alt="Club Heritage" 
                  className="w-full h-full object-cover brightness-[0.6] contrast-125 saturate-[0.8] group-hover:scale-105 group-hover:brightness-[0.8] transition-all duration-[4s] ease-out" 
                />
                
                {/* Cinematic Tint Overlays */}
                <div className="absolute inset-0 bg-gradient-to-t from-obsidian via-transparent to-emerald/10" />
                
                {/* Floating Stat Badge (The "Steward Card") */}
                <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[90%] backdrop-blur-3xl bg-white/[0.02] border border-white/10 p-8 rounded-club flex justify-around items-center">
      ...
      <div className="max-w-7xl mx-auto w-full px-6 lg:px-20 py-12 flex justify-between items-center relative z-20 border-t border-white/5">
         <div className="flex items-center gap-6">
            ...
            <span className="text-[10px] font-black uppercase tracking-registry text-white/20">Stewardship Registry Active</span>
         </div>
