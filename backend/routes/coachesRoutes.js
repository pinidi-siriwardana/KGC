...
const { getCoaches, getPublicCoaches, createCoach, updateCoach, updateCoachPhoto, deleteCoach } = require('../controllers/coachController');
const { uploadCoachPhoto } = require('../middleware/upload');
...
router.post('/:id/photo', validate(idParam(), 'params'), uploadCoachPhoto.single('photo'), updateCoachPhoto);
